...
$file = '/var/www/database_password.raw';
...
<form action="<?php echo ossn_installation_paths()->url; ?>?action=install" method="post">
	<?php if(!is_file($file)){ ?>
    	<div class='ossn-installation-message ossn-installation-fail'>
        	There is something wrong with installation. Please post this on https://www.opensource-socialnetwork.org/community 
        </div>
    <?php } else { 
    ...
    <div>
        ...
        <input type="text" name="dbuser" value="ossndb" placeholder="<?php echo ossn_installation_print('ossn:dbuser'); ?>"/>
        <input type="password" name="dbpwd" value="<?php echo $password;?>" readonly placeholder="<?php echo ossn_installation_print('ossn:dbpassword'); ?>"/>
        <input type="text" name="dbname" value="ossndb" placeholder="<?php echo ossn_installation_print('ossn:dbname'); ?>"/>
        <input type="text" name="dbhost" value="localhost" placeholder="<?php echo ossn_installation_print('ossn:dbhost'); ?>"/>
    </div>
